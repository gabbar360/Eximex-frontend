    ...
    <div className="bg-white/95 backdrop-blur-xl rounded-2xl lg:rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
      ...
      <div className="bg-white p-4 border-b-2" style={{borderColor: '#86a0b2'}}>
            ...
            return (
              <div key={step.id} className="flex items-center">
                <div className={`relative flex items-center justify-center w-8 h-8 rounded-xl transition-all duration-300 ${
                  ...
                  {currentStep > step.id ? (
                    <FaCheck className="w-4 h-4" style={{color: '#4a5568'}} />
                  ) : (
                    <IconComponent className="w-4 h-4" style={{color: '#4a5568'}} />
                  )}
                  {currentStep === step.id && (
                    <div className="absolute -inset-1 bg-white/30 rounded-xl animate-pulse" />
                  )}
                </div>
                {index < steps.length - 1 && (
                  <div className={`w-8 h-1 mx-2 rounded-full transition-all duration-500`} style={{
        ...
        <div className="text-center">
          <h2 className="text-lg font-bold mb-1" style={{color: '#86a0b2'}}>
