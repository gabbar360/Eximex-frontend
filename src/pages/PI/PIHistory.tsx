            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center py-12 sm:py-16 lg:py-20">
                ...
                <p className="text-sm sm:text-base text-gray-600 text-center px-4">
                  Please wait while we fetch the timeline...
                </p>
              </div>
            ) : history.length === 0 ? (
              <div className="text-center py-12 sm:py-16 lg:py-20">
                ...
                <p className="text-sm sm:text-base text-gray-600 max-w-md mx-auto px-4">
                  This invoice doesn't have any recorded history yet. Activities
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  {history.map((item, index) => (
                    <div
                      key={item.id || index}
                      className="relative mb-6 sm:mb-8 lg:mb-12 sm:ml-12 lg:ml-16"
                    >
                      {/* Timeline dot - Hidden on mobile */}
                      <div className="hidden sm:block absolute -left-8 lg:-left-12 top-4 sm:top-6">
                        <div
                          className={`w-6 h-6 sm:w-8 sm:h-8 rounded-lg border-2 sm:border-4 border-white flex items-center justify-center shadow-lg ${
                            item.action === 'CREATE'
                              ? 'bg-emerald-600'
                              : item.action === 'UPDATE'
                                ? 'bg-slate-600'
                          ...
                          {item.statusBefore !== item.statusAfter && (
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-4 sm:mb-6 p-3 sm:p-4 bg-gray-50 rounded-lg border border-gray-200">
                              ...
                              <div className="flex items-center justify-center gap-2 sm:gap-2">
                                ...
                                <FontAwesomeIcon
                                  icon={faArrowLeft}
                                  className="w-3 h-3 sm:w-4 sm:h-4 text-slate-500 rotate-180"
                                />
                              </div>
                              <span
                            ...
                            <div className="mt-3 sm:mt-4 border-t border-gray-200 pt-3 sm:pt-4">
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 text-xs sm:text-sm">
                                ...
                                <div className="bg-gray-50 p-2 sm:p-3 rounded-lg">
                                  ...
                                  <span className="text-gray-900 font-semibold">
                                    {item.changeData.products?.length || 0}{' '}
                                    items
                                  </span>
                                </div>
                              </div>
