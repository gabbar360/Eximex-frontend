...
import { HiShieldCheck, HiUser, HiCog6Tooth, HiPencil, HiUserGroup } from 'react-icons/hi2';
  ...
  const renderPermissionControls = (item, keyPrefix) => {
    ...
    return (
      <div className="grid grid-cols-4 gap-4 p-4 border border-gray-200 rounded-lg bg-gray-50">
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700 mb-2">Create</label>
          <Switch
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700 mb-2">Update</label>
          <Switch
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700 mb-2">Delete</label>
          <Switch
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
          {loading ? (
            <div className="p-12 text-center">
              ...
              <p className="text-slate-600 dark:text-gray-400 font-medium">Loading users...</p>
            </div>
            ...
            <div className="p-12 text-center">
              ...
              <h3 className="text-xl font-semibold text-slate-800 dark:text-white mb-2">No users found</h3>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 dark:text-blue-300">
                  Only menus with at least one permission enabled will be saved. Configure permissions carefully to ensure proper access control.
                </p>
              </div>
            </div>
          </div>
